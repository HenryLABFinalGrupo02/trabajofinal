...
more_reviews = pickle.load(open(r'/opt/data/initial_load/more_reviews.pkl','rb'))
more_reviews_users = pickle.load(open(r'/opt/data/initial_load/more_reviews_users.pkl','rb'))
more_reviews_users = more_reviews_users[:(int(len(more_reviews_users)/2))]
...
def load_tips():
    ...
    print('DROPPING TABLE IF EXISTS')
    session.execute("DROP TABLE IF EXISTS yelp.tip;")
...
def load_review():
    ...
    print('DROPPING TABLE IF EXISTS')
    session.execute("DROP TABLE IF EXISTS yelp.review;")
...
def load_sentiment_business():
    sentiment = pd.read_csv(r'/opt/data/sentiment_ok_unique.csv')
    ...
    print('DROPPING TABLE IF EXISTS')
    session.execute("DROP TABLE IF EXISTS yelp.sentiment_business;")
